...
public class BankCodeAnalysis2Sql {
  ...
  private static void sxBanks() {
    try {
      FileInputStream inputStream = new FileInputStream("/Users/huwenqi/Desktop/印尼贷超银行列表 0629.xls");
  ...
  private static void ccBanks() {
    try {
      FileInputStream inputStream = new FileInputStream("/Users/huwenqi/Desktop/印尼贷超银行列表 0604.xls");
      // HSSFWorkbook 一次性将整个excel读入内存
      Workbook workbook = WorkbookFactory.create(inputStream);
      Sheet sheet = workbook.getSheetAt(0);
      List<List<String>> list = FileRead.readSheet(sheet);
  ...
  private static void hrBanks() {
    try {
      FileInputStream inputStream = new FileInputStream("/Users/huwenqi/Desktop/印尼贷超银行列表 0601.xls");
      // HSSFWorkbook 一次性将整个excel读入内存
      Workbook workbook = WorkbookFactory.create(inputStream);
      Sheet sheet = workbook.getSheetAt(0);
      List<List<String>> list = FileRead.readSheet(sheet);
                ...
                single -> {
                  String s =
                      "('1', '+66', '"
                          ...
                          + single.get(1)
                          + "','"
                          + ("常用".equals(single.get(2)) ? "ACTIVE" : "INACTIVE")
                          + "'),";
                  System.out.println(s);
                });
      } catch (Exception e) {
                ...
                single -> {
                  String s =
                      "('1', '+62', '"
                          ...
                          + single.get(1)
                          + "','"
                          + ("是".equals(single.get(2)) ? "ACTIVE" : "INACTIVE")
                          + "'),";
                  System.out.println(s);
                });
      } catch (Exception e) {
  ...
  public static void marketBanks() {
    try {
      FileInputStream inputStream = new FileInputStream("/Users/huwenqi/Desktop/印尼贷超银行列表.xls");
      // HSSFWorkbook 一次性将整个excel读入内存
      Workbook workbook = WorkbookFactory.create(inputStream);
      Sheet sheet = workbook.getSheetAt(0);
      List<List<String>> list = FileRead.readSheet(sheet);
